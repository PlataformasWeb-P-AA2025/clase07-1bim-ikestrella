...
#    print(f"Estudiante: {e.id} - {e.apellido}")
...
# se recorre matriculas para obtener los estudiantes con matriculas por la relacion en la clase de Matricula con Estudiante
for m in matriculas:
